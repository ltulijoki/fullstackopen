describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.addedBlog').contains('a new blog an awesome blog by blogger added')
      cy.contains('an awesome blog blogger')
    })

    describe('When blog is created', function() {
      beforeEach(function() {
        cy.createBlog({ title: 'an awesome blog', author: 'blogger', url: 'http://blogsurl.fi' })
      })
      ...
      it('Blogs are sorted by likes', function() {
        cy.createBlog({ title: 'second', author: 'blogger', url: 'http://blogsurl.fi' })
